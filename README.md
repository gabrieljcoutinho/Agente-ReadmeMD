...
## Estrutura Base para o Readme.md
...
### Títulos
- # TITULO nivel 1 (um hashtag)
- ## TITULO nivel 2 (dois hashtags)

### Citações
> Citação de algo ou alguém
...
### Comandos de Código
Comando entre uma crase: `console.log()`

Comando em bloco (três crases):
```javascript
if(idade >= 18){
